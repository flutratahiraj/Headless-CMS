...
var layout = __webpack_require__(8771);
...
const utbildning_Arbete=({data})=>{const nodes=data.allContentfulUtbildning.nodes;// Inline CSS-stilar som en JavaScript-objekt
