...
const CategoryList = ({
  ...
  const categories = Array.from(new Set(data.allContentfulKaffefilosofi.nodes.map(post => post.category)));
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "V\xE4lj en kategori:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("select", {
    onChange: e => (0,gatsby__WEBPACK_IMPORTED_MODULE_1__.navigate)(`/category/${e.target.value}/`)
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("option", {
    value: "",
    disabled: true,
    selected: true
  }, "V\xE4lj en kategori"), categories.map(category => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("option", {
    key: category,
    value: category
  }, category))));
};
const pageQuery = "2795462681";
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CategoryList);
const Head = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title", null, "Category List");
...
const Test = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("main", {
    ...
    data: data
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("ul", null, data.allContentfulKaffefilosofi.edges.map(({
    node
